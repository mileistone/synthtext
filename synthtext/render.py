...
from . import synth_utils as synth
from . import text_utils
from .colorize_poisson import Colorize
from .common import TimeoutException, time_limit
...
class TextRegions(object):
    ...
    def filter(seg, area, label):
        ...
        for idx, i in enumerate(good):
            ...
            f = (h > TextRegions.minHeight and w > TextRegions.minWidth
    ...
    def filter_depth(xyz, seg, regions):
        ...
        for idx, l in enumerate(regions['label']):
            ...
            # get-depths
            pt = xyz[mask]
            plane_model = synth.isplanar(pt, pt_sample, TextRegions.dist_thresh,
...
class Renderer(object):
    def __init__(self, data_dir, max_time=None):
        self.text_renderer = text_utils.RenderFont(data_dir)
